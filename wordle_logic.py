'''
Wordle Game Logic
Game logic required for playing game of Wordle.
'''
...
from wordle_types import LetterState


def evaluate_guess(guess: str, answer: str) -> Iterator[LetterState]:
    '''
    Return an iterable containing the LetterState of each letter in 
    guess string when compared to answer string.
    ...
    True
    >>> list(evaluate_guess("guess", "guide")) == [LetterState.CORRECT, LetterState.CORRECT, LetterState.PRESENT, LetterState.ABSENT, LetterState.ABSENT]
    True
    '''
...
def generate_new_word():
    '''
    Return a random word as a new game solution.
    '''
